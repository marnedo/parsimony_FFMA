...
#' 
## ----Parsimony ratchet, message=FALSE, include=FALSE, results='hidden'-------------------------------
...
#' 
## ----message=FALSE, include=FALSE, results='hidden'--------------------------------------------------
...
#' 
## ----More intense ratchet, message=FALSE, include=FALSE, results='hidden'----------------------------
...
#' 
## ----ILD_function_combined tree once-----------------------------------------------------------------
